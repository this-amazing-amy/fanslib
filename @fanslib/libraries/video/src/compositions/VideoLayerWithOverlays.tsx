...
export type VideoLayerWithOverlaysProps = {
  /** The video element(s) to render as the base layer */
  children: React.ReactNode;
  operations: Operation[];
  assetUrls: Record<string, string>;
};

export const VideoLayerWithOverlays: React.FC<VideoLayerWithOverlaysProps> = ({
  children,
  operations,
  assetUrls,
}) => {
