export const HowToUse = () => (
  <div className="bg-base-200 rounded-xl p-6">
    ...
    <ol className="space-y-3 text-sm text-base-content/80 list-decimal list-inside">
      ...
      <li>
        Enter the full absolute path to your library folder (e.g., /Users/you/Pictures/library)
      </li>
      <li>
        Click &quot;Verify Folder Access&quot; and select your library folder to confirm it works
      </li>
