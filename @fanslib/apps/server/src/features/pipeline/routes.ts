...
import { AssignMediaRequestBodySchema, FetchCaptionQueueRequestQuerySchema } from "./schema";
...
export const pipelineRoutes = new Hono()
  ...
  .get(
    "/caption-queue",
    zValidator("query", FetchCaptionQueueRequestQuerySchema, validationError),
    async (c) => {
