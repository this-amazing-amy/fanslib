...
export const DropdownMenuPopover = ({
  children,
  className,
  offset = 4,
  ...props
...
export const DropdownMenu = ({ children, className, ...props }: MenuProps) => (
...
export const DropdownMenuItem = ({ children, className, ...props }: MenuItemProps) => (
  <AriaMenuItem
    className={cn(
...
export const DropdownMenuLabel = ({ children, className }: DropdownMenuLabelProps) => (
  <div
    className={cn("px-2 py-1.5 text-xs font-semibold text-base-content/70 uppercase", className)}
  >
    {children}
  </div>
);
