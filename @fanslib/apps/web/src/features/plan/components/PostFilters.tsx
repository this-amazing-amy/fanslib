...
import { defaultPreferences, type PlanFilterPreferences } from "~/contexts/PlanPreferencesContext";
...
const areFiltersEqual = (a: PlanFilterPreferences, b: PlanFilterPreferences): boolean => {
