            ...
            <div className="text-sm flex-1">
              ...
              {post.blueskyRetryCount >= 3 ? (
                <p className="mt-2 text-xs">
                  Maximum retries reached. Fix the issue and click &quot;Reset &amp; Retry&quot; to
                  try again.
                </p>
              ) : (
                <p className="mt-2 text-xs">
                  The system will retry automatically ({post.blueskyRetryCount}/3 attempts). You can
                  also manually mark as posted or move back to draft.
                </p>
              )}
              {post.blueskyRetryCount >= 3 && (
                <Button
